...
debug_log "{\"sessionId\":\"415745\",\"location\":\"run_terminal_agent.sh:pre-run\",\"message\":\"script about to run agent\",\"data\":{\"MODE\":\"$MODE\",\"AGENT_CMD\":\"$AGENT_CMD\",\"prompt_len\":${#ESCAPED},\"PROJECT_PATH\":\"$PROJECT_PATH\"},\"timestamp\":$(date +%s000),\"hypothesisId\":\"H3\"}"
# #endregion
...
debug_log "{\"sessionId\":\"415745\",\"location\":\"run_terminal_agent.sh:prompt-debug\",\"message\":\"prompt content check\",\"data\":{\"prompt_len\":${#ESCAPED},\"prompt_first\":\"$PROMPT_FIRST\",\"prompt_last\":\"$PROMPT_LAST\"},\"timestamp\":$(date +%s000),\"hypothesisId\":\"H3\"}"
...
if [ -n "$MODE" ]; then
    ...
    debug_log "{\"sessionId\":\"415745\",\"location\":\"run_terminal_agent.sh:with-mode\",\"message\":\"invoking agent with mode\",\"data\":{\"MODE\":\"$MODE\",\"AGENT_CMD\":\"$AGENT_CMD\"},\"timestamp\":$(date +%s000),\"hypothesisId\":\"H2\"}"
    ...
    AGENT_PID=$!
    debug_log "{\"sessionId\":\"415745\",\"location\":\"run_terminal_agent.sh:agent-started\",\"message\":\"agent process started\",\"data\":{\"AGENT_PID\":$AGENT_PID},\"timestamp\":$(date +%s000),\"hypothesisId\":\"H5\"}"
    wait $AGENT_PID
    AGENT_EXIT=$?
else
...
debug_log "{\"sessionId\":\"415745\",\"location\":\"run_terminal_agent.sh:post-run\",\"message\":\"agent exited\",\"data\":{\"AGENT_EXIT\":$AGENT_EXIT,\"MODE\":\"$MODE\",\"stdout\":\"$AGENT_OUTPUT_SNIPPET\",\"stderr\":\"$AGENT_STDERR_SNIPPET\"},\"timestamp\":$(date +%s000),\"hypothesisId\":\"H4\"}"
echo ""
