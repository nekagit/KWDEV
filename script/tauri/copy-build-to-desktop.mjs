#!/usr/bin/env node
/**
 * After tauri:build, copy the bundle to ~/Desktop/KWDEV.
...
const desktopDir = path.join(process.env.HOME, "Desktop", "KWDEV");
...
// Copy bundle contents (macos/*.app, etc.) into Desktop/KWDEV
