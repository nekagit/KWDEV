...
- The primary KWDEV workspace root is `/Users/nenadkalicanin/Documents/KW/Products/KWDEV`.
- The desktop application is built with Tauri and loads the Next.js frontend at `http://127.0.0.1:4000` in development.
